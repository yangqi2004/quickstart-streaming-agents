...
4. NOTIFY: If issues found, use the gmail_send_email tool to send a notification email. Use the exact format provided in the prompt for the email subject and body.
...
LATERAL TABLE(AI_RUN_AGENT(
    ...
    CONCAT(
        'EMAIL RECIPIENT: <EMAIL ADDRESS HERE>',
